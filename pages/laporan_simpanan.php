...
<div class="main-content">
        <div class="container-fluid">
          	<h3><a href="?p=home">Beranda </a><i class="fa fa-angle-right"></i> Laporan Simpanan</h3>
...
<form method="post" action="pages/cetak_laporan_simpanan.php" class="form-horizontal" target="_blank" >

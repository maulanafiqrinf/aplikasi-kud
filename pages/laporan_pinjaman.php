...
<div class="main-content">
        <div class="container-fluid">
          	<h3><a href="?p=home">Beranda </a><i class="fa fa-angle-right"></i> Laporan Pinjaman</h3>
...
<form method="post" action="pages/cetak_laporan_pinjaman.php" class="form-horizontal" target="_blank" >
